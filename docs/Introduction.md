...
- Director has preset camera views and 4 working screens: Studio Preview, Studio Live, TV Preview, TV Live. 
- Studio is a virtual scene that has Presenter, Audience and the Screen
- Screen displays Studio Live content that is selected by the Director. Screen content dynamically changes when Director selects another source.
- Any director can select new source  
...
- Guest is an invited person eg. celebrity or expert. Guest is located in the Studio. Guest can talk with Reporter. Guest can not hear the Director(? maybe)
- Both reporter and guest share the same role Presenter
